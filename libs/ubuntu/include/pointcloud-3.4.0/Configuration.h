...
#define CALIB_TEMP_OFFSET   "calib_temp_offset"

#define MAX_NL_CURVE_COEFF_A  "freq1_nonlinear_curve_coefficient_a"
#define MAX_NL_CURVE_COEFF_B  "freq1_nonlinear_curve_coefficient_b"
#define MAX_NL_CURVE_COEFF_C  "freq1_nonlinear_curve_coefficient_c"
#define MAX_NL_CURVE_COEFF_D  "freq1_nonlinear_curve_coefficient_d"
#define MIN_NL_CURVE_COEFF_A  "freq2_nonlinear_curve_coefficient_a"
#define MIN_NL_CURVE_COEFF_B  "freq2_nonlinear_curve_coefficient_b"
#define MIN_NL_CURVE_COEFF_C  "freq2_nonlinear_curve_coefficient_c"
#define MIN_NL_CURVE_COEFF_D  "freq2_nonlinear_curve_coefficient_d"
...
namespace PointCloud
{
	...
	public:
		...
		double getDouble(const String &section, const String &name) const;
		...
		void setConfigFileName(String& fileName) { _fileName = fileName; }
		bool serializeAllDataFiles(OutputStream &out, String& key, Vector<uint8_t>& data);
	...
	public:
		...
		inline bool hasHardwareConfigurationSupport() {
			return _hardwareSerializer && *_hardwareSerializer;
		}
