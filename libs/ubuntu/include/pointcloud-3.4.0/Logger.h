...
class UTIL_EXPORT LoggerOutStream
{
public:
...
protected:
  ...
  // String _logLevelNames[5] = { "CRITICAL", "ERROR", "WARNING", "INFO", "DEBUG" };
...
extern  Logger UTIL_EXPORT logger;

//UTIL_EXPORT Logger & endl(Logger &l);

class UTIL_EXPORT LogLevelChanger
{
