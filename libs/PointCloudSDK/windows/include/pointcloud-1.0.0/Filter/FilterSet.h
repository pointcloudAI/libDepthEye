...
#ifndef POINTCLOUD_FRAME_FILTER_SET_H
...
public:  
  ...
  FilterSet(FrameBufferManager<FrameType> &m):  _filterCounter(0),_frameBufferManager(m) { _indices.reserve(10); }
...
template <typename FrameType>
FilterSetIterator<FrameType>::FilterSetIterator(const FilterSet<FrameType> &s, int i):  i(i) ,s(s)
{
...
#endif //POINTCLOUD_FRAME_FILTER_SET_H
